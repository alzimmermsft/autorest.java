...
public class JavaSettings {
    ...
    public static JavaSettings getInstance() {
        if (instance == null) {
            ...
            instance = new JavaSettings(
                ...
                getIntValue(host, "eclipse-language-server-startup-timeout-millis", 10_000)
            );
        }
        return instance;
    }
     ...
     * @param eclipseLanguageServerStartupTimeoutMillis Timeout in milliseconds for the code customization Eclipse language
     * server to start up. If unspecified, the default timeout is 10 seconds.
     */
    private JavaSettings(AutorestSettings autorestSettings,
        ...
        int eclipseLanguageServerStartupTimeoutMillis) {
        ...
        this.eclipseLanguageServerStartupTimeoutMillis = eclipseLanguageServerStartupTimeoutMillis;
    }
    ...
    private final int eclipseLanguageServerStartupTimeoutMillis;

    /**
     * Timeout in milliseconds for the code customization Eclipse Language Server to start up.
     *
     * @return Timeout in milliseconds for the code customization Eclipse Language Server to start up.
     */
    public int getEclipseLanguageServerStartupTimeoutMillis() {
        return eclipseLanguageServerStartupTimeoutMillis;
    }
    ...
    private static int getIntValue(NewPlugin host, String settingName, int defaultValue) {
        String ret = host.getStringValue(settingName);
        if (ret == null) {
            return defaultValue;
        } else {
            logger.debug("Option, int, {} : {}", settingName, ret);
            SIMPLE_JAVA_SETTINGS.put(settingName, ret);
